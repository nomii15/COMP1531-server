...
def test_auth_register5():
    ...
    #valid u_id and token, u_id is 2 as a succesful account is 
    #created above
    
    assert auth_register("z5110036@unsw.edu.au", "SomePassword", "Daniel", "Setkiewicz") == {'u_id': 2, 'token': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1X2lkIjoyfQ.2QcZ_q4JJoHF-NQC1qWnsEcuPElVzN8T44LQgr-UyNo'}             
